...
function populateImagesFromLocalStorage() {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    if (key.startsWith('image_')) {
      const imageUrl = localStorage.getItem(key);
      imagesFound = true; // An image was found
  ...
  function exportToJson() {
    ...
    var equipmentPart8Value = document.querySelector('input[name="equipmentPart8"]').value;
    var equipmentSerial8Value = document.querySelector('input[name="equipmentSerial8"]').value;
    ...
    var data = {
      ...
      recordEquipment: {
        ...
        equipmentPart8: equipmentPart8Value,
        equipmentSerial8: equipmentSerial8Value,
  ...
  function fillFormFromJsonORIG(data) {
    ...
    form.elements.equipmentManufact1.value = data.equipmentManufact1;
    form.elements.equipmentModel1.value = data.equipmentModel1;
    form.elements.equipmentPartNo1.value = data.equipmentPartNo1;
    form.elements.equipmentSerialNo1.value = data.equipmentSerialNo1;
    form.elements.equipmentLocation1.value = data.equipmentLocation1;
    form.elements.recordEquipment2.value = data.recordEquipment2;
    form.elements.equipmentManufact2.value = data.equipmentManufact2;
    form.elements.equipmentModel2.value = data.equipmentModel2;
    form.elements.equipmentPartNo2.value = data.equipmentPartNo2;
    form.elements.equipmentSerialNo2.value = data.equipmentSerialNo2;
    form.elements.equipmentLocation2.value = data.equipmentLocation2;
    form.elements.recordEquipment3.value = data.recordEquipment3;
    form.elements.equipmentManufact3.value = data.equipmentManufact3;
    form.elements.equipmentModel3.value = data.equipmentModel3;
    form.elements.equipmentPartNo3.value = data.equipmentPartNo3;
    form.elements.equipmentSerialNo3.value = data.equipmentSerialNo3;
    form.elements.equipmentLocation3.value = data.equipmentLocation3;
    form.elements.recordEquipment4.value = data.recordEquipment4;
    form.elements.equipmentManufact4.value = data.equipmentManufact4;
    form.elements.equipmentModel4.value = data.equipmentModel4;
    form.elements.equipmentPartNo4.value = data.equipmentPartNo4;
    form.elements.equipmentSerialNo4.value = data.equipmentSerialNo4;
    form.elements.equipmentLocation4.value = data.equipmentLocation4;
    form.elements.recordEquipment5.value = data.recordEquipment5;
    form.elements.equipmentManufact5.value = data.equipmentManufact5;
    form.elements.equipmentModel5.value = data.equipmentModel5;
    form.elements.equipmentPartNo5.value = data.equipmentPartNo5;
    form.elements.equipmentSerialNo5.value = data.equipmentSerialNo5;
    form.elements.equipmentLocation5.value = data.equipmentLocation5;
    form.elements.recordEquipment6.value = data.recordEquipment6;
    form.elements.equipmentManufact6.value = data.equipmentManufact6;
    form.elements.equipmentModel6.value = data.equipmentModel6;
    form.elements.equipmentPartNo6.value = data.equipmentPartNo6;
    form.elements.equipmentSerialNo6.value = data.equipmentSerialNo6;
    form.elements.equipmentLocation6.value = data.equipmentLocation6;
    form.elements.recordEquipment7.value = data.recordEquipment7;
    form.elements.equipmentManufact7.value = data.equipmentManufact7;
    form.elements.equipmentModel7.value = data.equipmentModel7;
    form.elements.equipmentPartNo7.value = data.equipmentPartNo7;
    form.elements.equipmentSerialNo7.value = data.equipmentSerialNo7;
    form.elements.equipmentLocation7.value = data.equipmentLocation7;
    form.elements.recordEquipment8.value = data.recordEquipment8;
    form.elements.equipmentManufact8.value = data.equipmentManufact8;
    form.elements.equipmentModel8.value = data.equipmentModel8;
    form.elements.equipmentPart8.value = data.equipmentPart8;
    form.elements.equipmentSerial8.value = data.equipmentSerial8;
    form.elements.equipmentLocation8.value = data.equipmentLocation8;
    form.elements.checkEquipment1.value = data.checkEquipment1;
    form.elements.checkVisual1.value = data.checkVisual1;
    form.elements.checkMech1.value = data.checkMech1;
    form.elements.checkCabling1.value = data.checkCabling1;
    form.elements.checkPower1.value = data.checkPower1;
    form.elements.checkEarthing1.value = data.checkEarthing1;
    form.elements.checkEquipment2.value = data.checkEquipment2;
    form.elements.checkVisual2.value = data.checkVisual2;
    form.elements.checkMech2.value = data.checkMech2;
    form.elements.checkCabling2.value = data.checkCabling2;
    form.elements.checkPower2.value = data.checkPower2;
    form.elements.checkEarthing2.value = data.checkEarthing2;
    form.elements.checkEquipment3.value = data.checkEquipment3;
    form.elements.checkVisual3.value = data.checkVisual3;
    form.elements.checkMech3.value = data.checkMech3;
    form.elements.checkCabling3.value = data.checkCabling3;
    form.elements.checkPower3.value = data.checkPower3;
    form.elements.checkEarthing3.value = data.checkEarthing3;
    form.elements.checkEquipment4.value = data.checkEquipment4;
    form.elements.checkVisual4.value = data.checkVisual4;
    form.elements.checkMech4.value = data.checkMech4;
    ...
    form.elements.checkCabling8.value = data.checkCabling8;
    form.elements.checkPower8.value = data.checkPower8;
    form.elements.checkEarthing8.value = data.checkEarthing8;
    form.elements.radarManufacturer.value = data.radarManufacturer;
    form.elements.radarModel.value = data.radarModel;
    form.elements.radarUse.value = data.radarUse;
    form.elements.radarTxtime.value = data.radarTxtime;
    form.elements.radarLocation.value = data.radarLocation;
    form.elements.radarSettings.value = data.radarSettings;
    form.elements.gpsCheck.value = data.gpsCheck;
    form.elements.gyroCheck.value = data.gyroCheck;
    form.elements.windCheck.value = data.windCheck;
    form.elements.draughtCheck.value = data.draughtCheck;
    form.elements.waveCheck.value = data.waveCheck;
    form.elements.videoCableType.value = data.videoCableType;
    form.elements.videoCableImpedance.value = data.videoCableImpedance;
    form.elements.videoCableComments.value = data.videoCableComments;
    form.elements.syncCableType.value = data.syncCableType;
    form.elements.syncCableImpedance.value = data.syncCableImpedance;
    form.elements.syncCableComments.value = data.syncCableComments;
    form.elements.azimuthCableType.value = data.azimuthCableType;
    form.elements.azimuthCableImpedance.value = data.azimuthCableImpedance;
    form.elements.azimuthCableComments.value = data.azimuthCableComments;
    form.elements.headingCableType.value = data.headingCableType;
    form.elements.headingCableImpedance.value = data.headingCableImpedance;
    form.elements.headingCableComments.value = data.headingCableComments;
    form.elements.videoJumper.value = data.videoJumper;
    form.elements.syncJumper.value = data.syncJumper;
    form.elements.azimuthJumper.value = data.azimuthJumper;
    form.elements.headingJumper.value = data.headingJumper;
    form.elements.pullupJumper.value = data.pullupJumper;
    form.elements.pulldownJumper.value = data.pulldownJumper;
    form.elements.amplifierType.value = data.amplifierType;
    form.elements.amplifierCheck.value = data.amplifierCheck;
    form.elements.amplifierComments.value = data.amplifierComments;
    form.elements.radarFirewallType.value = data.radarFirewallType;
    form.elements.radarFirewallCheck.value = data.radarFirewallCheck;
    form.elements.radarFirewallComments.value = data.radarFirewallComments;
    form.elements.serialInterfaceType.value = data.serialInterfaceType;
    form.elements.serialInterfaceCheck.value = data.serialInterfaceCheck;
    form.elements.serialInterfaceComments.value = data.serialInterfaceComments;
    form.elements.networkEquipment1.value = data.networkEquipment1;
    form.elements.equipmentIpAddress1.value = data.equipmentIpAddress1;
    form.elements.equipmentSubnetMask1.value = data.equipmentSubnetMask1;
    form.elements.equipmentDefaultGateway1.value = data.equipmentDefaultGateway1;
    form.elements.equipmentMac1.value = data.equipmentMac1;
    form.elements.networkEquipment2.value = data.networkEquipment2;
    form.elements.equipmentIpAddress2.value = data.equipmentIpAddress2;
    form.elements.equipmentSubnetMask2.value = data.equipmentSubnetMask2;
    form.elements.equipmentDefaultGateway2.value = data.equipmentDefaultGateway2;
    form.elements.equipmentMac2.value = data.equipmentMac2;
    form.elements.networkEquipment3.value = data.networkEquipment3;
    form.elements.equipmentIpAddress3.value = data.equipmentIpAddress3;
    form.elements.equipmentSubnetMask3.value = data.equipmentSubnetMask3;
    form.elements.equipmentDefaultGateway3.value = data.equipmentDefaultGateway3;
    form.elements.equipmentMac3.value = data.equipmentMac3;
    form.elements.networkEquipment4.value = data.networkEquipment4;
    form.elements.equipmentIpAddress4.value = data.equipmentIpAddress4;
    form.elements.equipmentSubnetMask4.value = data.equipmentSubnetMask4;
    form.elements.equipmentDefaultGateway4.value = data.equipmentDefaultGateway4;
    form.elements.equipmentMac4.value = data.equipmentMac4;
    form.elements.networkEquipment5.value = data.networkEquipment5;
    form.elements.equipmentIpAddress5.value = data.equipmentIpAddress5;
    form.elements.equipmentSubnetMask5.value = data.equipmentSubnetMask5;
    form.elements.equipmentDefaultGateway5.value = data.equipmentDefaultGateway5;
    form.elements.equipmentMac5.value = data.equipmentMac5;
    form.elements.networkEquipment6.value = data.networkEquipment6;
    form.elements.equipmentIpAddress6.value = data.equipmentIpAddress6;
    form.elements.equipmentSubnetMask6.value = data.equipmentSubnetMask6;
    form.elements.equipmentDefaultGateway6.value = data.equipmentDefaultGateway6;
    form.elements.equipmentMac6.value = data.equipmentMac6;
    form.elements.networkEquipment7.value = data.networkEquipment7;
    form.elements.equipmentIpAddress7.value = data.equipmentIpAddress7;
    form.elements.equipmentSubnetMask7.value = data.equipmentSubnetMask7;
    form.elements.equipmentDefaultGateway7.value = data.equipmentDefaultGateway7;
    form.elements.equipmentMac7.value = data.equipmentMac7;
    form.elements.networkEquipment8.value = data.networkEquipment8;
    form.elements.equipmentIpAddress8.value = data.equipmentIpAddress8;
    form.elements.equipmentSubnetMask8.value = data.equipmentSubnetMask8;
    form.elements.equipmentDefaultGateway8.value = data.equipmentDefaultGateway8;
    form.elements.equipmentMac8.value = data.equipmentMac8;
    form.elements.networkDns.value = data.networkDns;
    form.elements.networkComments.value = data.networkComments;
    form.elements.cloudHost1.value = data.cloudHost1;
    form.elements.cloudHost2.value = data.cloudHost2;
    form.elements.computerStartup.value = data.computerStartup;
    form.elements.systemRequirements.value = data.systemRequirements;
    form.elements.windowsVersion.value = data.windowsVersion;
    form.elements.wavexStartup.value = data.wavexStartup;
    form.elements.wavexOptions.value = data.wavexOptions;
    form.elements.thirdPartyStartup.value = data.thirdPartyStartup;
    form.elements.storageSpace.value = data.storageSpace;
    form.elements.remoteAccessTools.value = data.remoteAccessTools;
    form.elements.serialMouseFix.value = data.serialMouseFix;
    form.elements.networkInterfaceConfig.value = data.networkInterfaceConfig;
    form.elements.windowsFirewall.value = data.windowsFirewall;
    form.elements.antiVirus.value = data.antiVirus;
    form.elements.gpsCheck2.value = data.gpsCheck2;
    form.elements.gyroCheck2.value = data.gyroCheck2;
    form.elements.windCheck2.value = data.windCheck2;
    form.elements.draughtCheck2.value = data.draughtCheck2;
    form.elements.waveCheck2.value = data.waveCheck2;
    form.elements.shaftCheck2.value = data.shaftCheck2;
    form.elements.em129Version.value = data.em129Version;
    form.elements.em129Settings.value = data.em129Settings;
    form.elements.em129SignalStatus.value = data.em129SignalStatus;
    form.elements.em129NetworkSettings.value = data.em129NetworkSettings;
    form.elements.em129InterfaceConfig.value = data.em129InterfaceConfig;
    form.elements.em129Scope.value = data.em129Scope;
    form.elements.em129Comments.value = data.em129Comments;
    form.elements.wavexDescription.value = data.wavexDescription;
    form.elements.wavexMovement.value = data.wavexMovement;
    form.elements.wavexLat.value = data.wavexLat;
    form.elements.wavexLong.value = data.wavexLong;
    form.elements.wavexHeading.value = data.wavexHeading;
    form.elements.wavexRadar.value = data.wavexRadar;
    form.elements.wavexMulticast.value = data.wavexMulticast;
    form.elements.wavexTransceiver.value = data.wavexTransceiver;
    form.elements.wavexRinId.value = data.wavexRinId;
    form.elements.wavexRinNetwork.value = data.wavexRinNetwork;
    form.elements.wavexImageStorage.value = data.wavexImageStorage;
    form.elements.wavexGPS.value = data.wavexGPS;
    form.elements.wavexGPSPositionSentence.value = data.wavexGPSPositionSentence;
    form.elements.wavexGPSTrackSpeedSentence.value = data.wavexGPSTrackSpeedSentence;
    form.elements.wavexGPSTimeSentence.value = data.wavexGPSTimeSentence;
    form.elements.wavexGPSSettings.value = data.wavexGPSSettings;
    form.elements.wavexGyro.value = data.wavexGyro;
    form.elements.wavexGyroSentence.value = data.wavexGyroSentence;
    form.elements.wavexGyroSettings.value = data.wavexGyroSettings;
    form.elements.wavexWind.value = data.wavexWind;
    form.elements.wavexWindSentence.value = data.wavexWindSentence;
    form.elements.wavexWindSettings.value = data.wavexWindSettings;
    form.elements.wavexWave.value = data.wavexWave;
    form.elements.wavexWaveSentence.value = data.wavexWaveSentence;
    form.elements.wavexWaveSettings.value = data.wavexWaveSettings;
    form.elements.wavexDraught.value = data.wavexDraught;
    form.elements.wavexDraughtSentence.value = data.wavexDraughtSentence;
    form.elements.wavexDraughtSettings.value = data.wavexDraughtSettings;
    form.elements.wavexGeometryRadarX.value = data.wavexGeometryRadarX;
    form.elements.wavexGeometryRadarY.value = data.wavexGeometryRadarY;
    form.elements.wavexGeometryRadarZ.value = data.wavexGeometryRadarZ;
    form.elements.wavexGeometryGPSX.value = data.wavexGeometryGPSX;
    form.elements.wavexGeometryGPSY.value = data.wavexGeometryGPSY;
    form.elements.wavexGeometryWindHeadingOffset.value = data.wavexGeometryWindHeadingOffset;
    form.elements.wavexGeometryWindZ.value = data.wavexGeometryWindZ;
    form.elements.wavexRadarRangeOffset.value = data.wavexRadarRangeOffset;
    form.elements.wavexRadarAzimuthOffset.value = data.wavexRadarAzimuthOffset;
    form.elements.wavexRadarStartAngle.value = data.wavexRadarStartAngle;
    form.elements.wavexRadarSectorSize.value = data.wavexRadarSectorSize;
    form.elements.wavexRadarStartRange.value = data.wavexRadarStartRange;
    form.elements.wavexRadarStopRange.value = data.wavexRadarStopRange;
    form.elements.wavexRadarImageCheck.value = data.wavexRadarImageCheck;
    form.elements.wavexAdvancedWaveAntennaMeanHeight.value = data.wavexAdvancedWaveAntennaMeanHeight;
    form.elements.wavexAdvancedWaveCartesianSections.value = data.wavexAdvancedWaveCartesianSections;
    form.elements.wavexAdvancedCurrentAntennaMeanHeight.value = data.wavexAdvancedCurrentAntennaMeanHeight;
    form.elements.wavexAdvancedCurrentCartesianSections.value = data.wavexAdvancedCurrentCartesianSections;
    form.elements.wavexOutput1.value = data.wavexOutput1;
    form.elements.wavexOutput1Sentence.value = data.wavexOutput1Sentence;
    form.elements.wavexOutput1UpdateInterval.value = data.wavexOutput1UpdateInterval;
    form.elements.wavexOutput1Settings.value = data.wavexOutput1Settings;
    form.elements.wavexOutput2.value = data.wavexOutput2;
    form.elements.wavexOutput2Sentence.value = data.wavexOutput2Sentence;
    form.elements.wavexOutput2UpdateInterval.value = data.wavexOutput2UpdateInterval;
    form.elements.wavexOutput2Settings.value = data.wavexOutput2Settings;
    form.elements.wavexOutput3.value = data.wavexOutput3;
    form.elements.wavexOutput3Sentence.value = data.wavexOutput3Sentence;
    form.elements.wavexOutput3UpdateInterval.value = data.wavexOutput3UpdateInterval;
    form.elements.wavexOutput3Settings.value = data.wavexOutput3Settings;
    form.elements.cloudEnabled.value = data.cloudEnabled;
    form.elements.finalConfig.value = data.finalConfig;
    form.elements.finalPowerCycle.value = data.finalPowerCycle;
    form.elements.final20Minute.value = data.final20Minute;
    form.elements.finalDataOutput.value = data.finalDataOutput;
    form.elements.backupWavexJson.value = data.backupWavexJson;
    form.elements.backupDF047.value = data.backupDF047;
    form.elements.backupEM129.value = data.backupEM129;
    form.elements.backupMisc.value = data.backupMisc;
    form.elements.loginType1.value = data.loginType1;
    form.elements.loginUsername1.value = data.loginUsername1;
    form.elements.loginPassword1.value = data.loginPassword1;
    form.elements.loginComments1.value = data.loginComments1;
    form.elements.loginType2.value = data.loginType2;
    form.elements.loginUsername2.value = data.loginUsername2;
    form.elements.loginPassword2.value = data.loginPassword2;
    form.elements.loginComments2.value = data.loginComments2;
  ...
  <p><span style="font-weight:bold;">Work Type:</span> <span style="font-weight:normal;">${selectedElements.workType}</span></p>
  ...
  <tr>
    <td style="padding-right: 20px;">
      <p><strong>System:</strong> ${selectedElements.system}</p>
      <p><strong>Site Type:</strong> ${selectedElements.siteType}</p>
      <p><strong>IMO:</strong> ${selectedElements.imo}</p>
    </td>
    <td style="padding-right: 20px;">
      <p><strong>Work Type:</strong> ${selectedElements.workType}</p>
      <p><strong>Customer:</strong> ${selectedElements.customer}</p>
      <p><strong>Location:</strong> ${selectedElements.location}</p>
    </td>
    <td>
      <p><strong>Site:</strong> ${selectedElements.site}</p>
      <p><strong>Date:</strong> ${selectedElements.date}</p>
      <p><strong>Engineer:</strong> ${selectedElements.engineer}</p>
    </td>
  </tr>
</table>
